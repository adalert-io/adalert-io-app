...
export default function LoginForm({ onSwitchToSignup }: LoginFormProps) {
  ...
  return (
    <div className="mt-[50px] w-full max-w-2xl px-0 flex flex-col items-center justify-center">
      <Card className="w-full border border-gray-200 rounded-xl bg-white shadow-none p-0">
        <CardContent className="p-10 md:p-16">
          ...
          <p className="text-gray-400 mb-6 text-base">Log in to your account</p>
