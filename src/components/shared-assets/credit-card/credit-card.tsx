    ...
    return (
        ...
        >
            ...
            >
                ...
                {type === "adalert-blue" && (
                    <>
                        <div className="pointer-events-none absolute -right-10 -top-10 size-40 rounded-full bg-white/15 blur-3xl" />
                        <div className="pointer-events-none absolute -bottom-12 -left-8 size-36 rounded-full bg-[#60a5fa]/35 blur-3xl" />
                        <div className="pointer-events-none absolute top-1/2 right-1/4 size-28 rounded-full bg-[#0146ca]/40 blur-2xl" />
                    </>
                )}
